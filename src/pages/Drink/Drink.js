...
class Drink extends React.Component {
  ...
  render() {
    const drink =
      [
        { name: "Manhattan", base_spirit: "whiskey", drink_type: "classic cocktail", img: "drew-beamer-manhattan-55.jpg", description: "The Manhattan is a classic whiskey cocktail devised in NYC's Manhattan Club.", recipe: ["2 oz Bourbon", "1 oz Sweet Vermouth", "2 dashes Angostura Bitters"], steps: ["Add all ingredients to a mixing glass with ice", "Stir until chilled", "Strain into another glass", "Garnish with a cherry"] },
            ...
            <section>
              ...
              <div className="row">
                <div className="major 4u">
                  <img className="drink-img" src={"../../images/alcoholic_drinks/" + info.base_spirit + "_drinks/" + info.img} /><br />
