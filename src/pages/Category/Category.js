            ...
            for (let j = 0; j < 3; j++) {
                if (descrip[ctr].length > 0) {
                    children.push(<Card
                        ...
                        title={fillData[ctr][0].toUpperCase() + fillData[ctr].slice(1) + " " + descrip[ctr][0].toUpperCase() + descrip[ctr].slice(1)}
                    />)
                    ...
                    children.push(<Card
                        route={"/" + this.props.match.params.category + "/shot"}
                        image_src={"images/alcoholic_drinks/" + fillData[ctr] + "_" + descrip[ctr] + "/" + fillData[ctr] + "-" + descrip[ctr] + ".jpg"}
                        title={fillData[ctr][0].toUpperCase() + fillData[ctr].slice(1)}
                    />)
